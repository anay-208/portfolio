...
export default function Introduction(){
    ...
    <div className=" ml-[5%] sm:ml-24">
      ...
      <FontAwesomeIcon icon={faEnvelope} className="mt-10 text-4xl text-white hover:text-emerald-300 transition-all cursor-pointer" onClick={() => window.open("mailto:admin@anayparaswani.me")}/>
    </div>
    </div>
