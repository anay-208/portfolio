...
import dkvk from "../images/dkvk.png"
import lifelog from "../images/lifelog.png"
export default function Projects() {
  const projects = [
    ...
    {
      title: "Lifelog",
      description: "A platform where you can create Journals, manage finances and create goals all in a single app(Built for Next.js Hackathon)",
  ...
  return (
    <div id="projects" className="relative flex h-fit min-h-screen w-screen flex-col items-start justify-center sm:rounded-sm sm:px-5">
      ...
      <div className="align-center grid w-full grid-cols-1 gap-3 justify-center  sm:grid-cols-3">
        {" "}
        {/* Projects card(s) */}
        {projects.map((project, index) => (
          <div key={index} className="flex h-auto w-full p-4 flex-col mx-auto">
            <Image
            ...
            <div className="rounded-b-md bg-slate-900">
              ...
              <p className="text-center mx-4 my-2 h-28 sm:h-20">{project.description} &nbsp;
                {project.about && <Link target="_blank" className=" text-blue-500 underline" href={project.about}>Read More</Link>}
              </p>
