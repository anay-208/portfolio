export default function Page() {
    return (
        <main className="min-h-screen bg-slate-950 text-white">
            ...
            <div className="mt-8 mx-4 sm:mx-12 flex flex-col items-center justify-center text-lg">
                <p className="font-sans text-center ">
                    These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding
                    agreement by and between ANAY PARASWANI, ( “Website Owner” or “we” or “us” or “our”) and you
                    ...
                    <ul className="text-left">
                        ...
                        jurisdiction of the courts in Agra, Uttar Pradesh.</li>
