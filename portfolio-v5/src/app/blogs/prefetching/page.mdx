...
In Next.js by default, the link is "partially preloaded" as soon as it enters the viewport. However, this could result in overwhelming prefetching requests, for instance, on a page with 50 links, thats 50 requests for prefetching fired just from scrolling. This is where ForesightJS comes to the rescue. 
